...
else if($RACE==0){echo "<b><font size='20px' face='標楷體'>全程賽</font>";}
 $_GET["G"];
if($G=="M"){echo "男子組";}
else if($G=="F"){echo "女子組";}
?>
</TD>

<TR>
<TD align="center"><? echo "<font face='標楷體'>抵達時間：" ;?></TD><TD align="center"><?echo "<font face='標楷體'>".$_GET["q"]; ?></TD></TR>
...
<TR>
<TR>
<TD align="center" colspan="2"><? echo "<font face='標楷體'>參賽第".$_GET["t"]."天";?></TD></TR>
