...
<div id="wrapper">
	...
	$str="SELECT `id`,`name`,`gender`,`day6time`,`day7time`,`day8time`,`sum` FROM `rundaytriple` where `GENDER`='M' order by `SUM` ;"; 
...
<?php 
$tt=0;
while (list($a,$b,$c,$d,$e,$f,$h)=mysql_fetch_row($result)){
$tt ++; 
?>
<TR ALIGN =CENTER>
<TD><?echo $tt;$ll=$tt;?></TD> 
...
<TD WIDTH = 120><?echo $f;?></TD> 
<TD WIDTH = 120><?echo $h;  $se=$h;?></TD> 
<TD>
